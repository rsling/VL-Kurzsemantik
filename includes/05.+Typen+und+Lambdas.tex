...
%  \onslide<+->
%  \Halbzeile
  Wie sieht \alert{Modelltheorie} für Quantifikation aus?\\
  Wie werden Quantoren und Variablen modelltheoretisch interpretiert?\\
  \onslide<+->
  \Halbzeile
  ...
  \onslide<+->
  \Halbzeile
  \grau{\footnotesize Texte für heute: \citet[Kapitel~4]{DowtyEa1981} | \citealt[Kapitel~3,7]{ChierchiaMcconnellginet2000}}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}[<+->]
    ...
    \item[$\vdash$~~] $\forall{}v_{0_{\ram{e,t}}}\ekm{\lambda{}x\ekm{(\mathbf{non}(v_{0_{\ram{e,t}}}))(x)}=\lambda{}x\ekm{\neg{}(v_{0_{\ram{e,t}}}(x))}}$
    \item[$\equiv$~~] $\forall{}v_{0_{\ram{e,t}}}\ekm{\mathbf{non}(v_{0_{\ram{e,t}}})=\lambda{}x\ekm{\neg{}(v_{0_{\ram{e,t}}}(x))}}$
    \item[$\vdash$~~] $\lambda{}v_{0_{\ram{e,t}}}\ekm{\mathbf{non}(v_{0_{\ram{e,t}}})}=\lambda{}v_{0_{\ram{e,t}}}\ekm{\lambda{}x\ekm{\neg{}(v_{0_{\ram{e,t}}}(x))}}$
    \item[$\equiv$~~] $\mathbf{non}=\lambda{}v_{0_{\ram{e,t}}}\ekm{\lambda{x}\ekm{\neg{}v_{0_{\ram{e,t}}}(x)}}$
  \end{itemize}
\end{frame}
